...
class TorchBmmPluginDynamic : public PluginDynamicBase {
 public:
...
class TorchBmmPluginDynamicCreator : public PluginCreatorBase {
 public:
  TorchBmmPluginDynamicCreator();
