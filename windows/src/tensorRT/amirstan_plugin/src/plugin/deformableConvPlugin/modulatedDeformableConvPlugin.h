...
class ModulatedDeformableConvPluginDynamic : public PluginDynamicBase {
 public:
  ...
  // It doesn't make sense to make ModulatedDeformableConvPluginDynamic without
...
class ModulatedDeformableConvPluginDynamicCreator : public PluginCreatorBase {
 public:
