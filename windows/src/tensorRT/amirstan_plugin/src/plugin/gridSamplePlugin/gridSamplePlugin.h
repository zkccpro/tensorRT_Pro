...
class GridSamplePluginDynamic : public PluginDynamicBase {
 public:
  GridSamplePluginDynamic(const std::string &name, int mode, int paddingMode,
                          bool alignCorners);

  GridSamplePluginDynamic(const std::string name, const void *data,
                          size_t length);

  // It doesn't make sense to make GridSamplePluginDynamic without arguments, so
  // we delete default constructor.
  GridSamplePluginDynamic() = delete;
...
class GridSamplePluginDynamicCreator : public PluginCreatorBase {
 public:
  GridSamplePluginDynamicCreator();
