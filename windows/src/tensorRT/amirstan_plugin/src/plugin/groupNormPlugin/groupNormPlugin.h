...
class GroupNormPluginDynamic : public PluginDynamicBase {
 public:
  ...
  // It doesn't make sense to make GroupNormPluginDynamic without arguments, so
...
class GroupNormPluginDynamicCreator : public PluginCreatorBase {
 public:
