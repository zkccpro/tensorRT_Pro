...
class CarafeFeatureReassemblePluginDynamic : public PluginDynamicBase {
 public:
  CarafeFeatureReassemblePluginDynamic(const std::string &name, int scaleFactor,
                                       int upKernel, int upGroup);

  CarafeFeatureReassemblePluginDynamic(const std::string name, const void *data,
                                       size_t length);

  // It doesn't make sense to make CarafeFeatureReassemblePluginDynamic without
  // arguments, so we delete default constructor.
  CarafeFeatureReassemblePluginDynamic() = delete;
...
class CarafeFeatureReassemblePluginDynamicCreator : public PluginCreatorBase {
 public:
